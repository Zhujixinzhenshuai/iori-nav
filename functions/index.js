...
export async function onRequest(context) {
  ...
  if (layoutMenuLayout === 'horizontal') {
      ...
      githubIconHtml = `
      <a href="https://dao.19960102.xyz/iori-nav" target="_blank" class="fixed top-4 left-4 z-50 hidden min-[550px]:flex items-center justify-center p-2 rounded-lg bg-white/80 backdrop-blur shadow-md hover:bg-white text-gray-700 hover:text-black transition-all" title="GitHub">
